...
public class YourOrder {
	public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//body/div[@id='a-page']/div[2]/div[1]/div[2]/div[1]/a[1]/div[1]/div[1]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//body/div[@id='a-page']/section[1]/div[1]/div[3]/ul[1]/li[2]/a[1]")).click();
        Thread.sleep(1000);
